...
public class UIstrings {
    ...
    public static final String SELECT_SHELTER = "Какой приют Вас интерисует?";
    ...
    public static final String REPORT_SENT = "Сегодшяшный отчет отправлен";
    public static final String REPORT_NOT_NEEDED = "Вам не нужно зтправльть отчет о питомце";
    ...
    public static final String USER_PHOTO_REPORT = "фото отчет от пользоваьеля";
    public static final String USER_REPORT = "Отчет от пользоваьеля";
